...
internal class PmxBuilder
{
  ...
  public string BuildStart()
  {
    try
    {
      this.pass = this.pass + (object) new Random().Next(9999) + "\\";
  ...
  private void test_bones()
  {
    ...
    pmxBone1.Name = ((Object) transform).name;
    ...
    for (int index = 0; index < componentsInChildren.Length; ++index)
    {
      ...
      pmxBone2.Name = ((Object) componentsInChildren[index]).name;
    ...
    Transform[] bones)
  {
    ...
    if (((BoneWeight) ref unityWeight).boneIndex0 >= 0 && ((BoneWeight) ref unityWeight).boneIndex0 < bones.Length)
      boneWeightArray[0].Bone = this.sbi(((Object) bones[((BoneWeight) ref unityWeight).boneIndex0]).name);
    ...
    if (((BoneWeight) ref unityWeight).boneIndex1 >= 0 && ((BoneWeight) ref unityWeight).boneIndex0 < bones.Length)
      boneWeightArray[1].Bone = this.sbi(((Object) bones[((BoneWeight) ref unityWeight).boneIndex1]).name);
    ...
    if (((BoneWeight) ref unityWeight).boneIndex2 >= 0 && ((BoneWeight) ref unityWeight).boneIndex0 < bones.Length)
      boneWeightArray[2].Bone = this.sbi(((Object) bones[((BoneWeight) ref unityWeight).boneIndex2]).name);
    ...
    if (((BoneWeight) ref unityWeight).boneIndex3 >= 0 && ((BoneWeight) ref unityWeight).boneIndex0 < bones.Length)
      boneWeightArray[3].Bone = this.sbi(((Object) bones[((BoneWeight) ref unityWeight).boneIndex3]).name);
  ...
  public void CreateMeshList()
  {
    ...
    for (int index1 = 0; index1 < componentsInChildren.Length; ++index1)
    {
      ...
      this.vertics_name[index1] = ((Object) ((Renderer) componentsInChildren[index1]).sharedMaterial).name;
  ...
  public void CreateMaterial(Material material, int count)
  {
    ...
    pmxMaterial.Name = ((Object) material).name;
    pmxMaterial.NameE = ((Object) material).name;
    ...
    {
      string str = ((Object) material).name;
      if (str.Contains("Instance"))
        str = str + "_(" + (object) ((Object) material).GetInstanceID() + ")";
  ...
  public void CreateBoneList()
  {
    ...
    for (int index = 0; index < componentsInChildren.Length; ++index)
    {
      ...
      pmxBone.Name = ((Object) componentsInChildren[index]).name;
  ...
  private void setParent()
  {
    for (int index1 = 0; index1 < this.skinnedMeshList.Count; ++index1)
    {
      ...
      {
        PmxBone pmxBone = this.serchBone(((Object) skinnedMesh.bones[index2]).name);
        if (pmxBone != null)
        {
          int num = this.serchBonei(((Object) skinnedMesh.bones[index2].parent).name);
          pmxBone.Parent = num;
        }
      }
    }
  ...
  private void addAccessory()
  {
    ...
    for (int index1 = 0; index1 < componentsInChildren.Length; ++index1)
    {
      ...
      PmxBone pmxBone = new PmxBone();
      pmxBone.Name = ((Object) componentsInChildren[index1]).name;
      pmxBone.Parent = this.sbi(((Object) componentsInChildren[index1]).name);
  ...
  public void vasicphy()
  {
    ...
    for (int index = 0; index < componentsInChildren1.Length; ++index)
      this.pmxFile.BodyList.Add(new PmxBody()
      {
        Name = ((Object) componentsInChildren1[index]).name,
        Bone = this.sbi(((Object) componentsInChildren1[index]).name),
    ...
    for (int index = 0; index < componentsInChildren2.Length; ++index)
      this.pmxFile.BodyList.Add(new PmxBody()
      {
        Name = ((Object) componentsInChildren2[index]).name,
        Bone = this.sbi(((Object) componentsInChildren2[index]).name),
